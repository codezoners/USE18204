...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 870.0, 365.0, 52.0, 20.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 870.0, 230.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 870.0, 270.0, 66.0, 20.0 ],
					"text" : "metro 25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 870.0, 300.0, 88.0, 20.0 ],
					"text" : "counter 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 870.0, 410.0, 90.000001192092896, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 765.0, 365.0, 52.0, 20.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 765.0, 230.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 765.0, 270.0, 66.0, 20.0 ],
					"text" : "metro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 765.0, 300.0, 88.0, 20.0 ],
					"text" : "counter 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 765.0, 410.0, 90.000001192092896, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 469.5, 415.0, 248.0, 130.0 ],
					"varname" : "embossr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 645.0, 155.0, 59.0, 20.0 ],
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.0, 20.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 645.0, 90.0, 95.0, 20.0 ],
					"text" : "counter 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 180.0, 90.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.0, 200.0, 90.000001192092896, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 225.0, 180.0, 214.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "twirlr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 240.0, 435.0, 128.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "pixl8r",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 240.0, 300.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "kaleidr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 575.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 195.0, 10.0, 346.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "grabbr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-12" : [ "pictctrl[19]", "pictctrl[1]", 0 ],
			"obj-1::obj-27" : [ "swatch[1]", "swatch[1]", 0 ],
			"obj-1::obj-28" : [ "Red tint", "Red tint", 0 ],
			"obj-1::obj-49" : [ "pictctrl[20]", "pictctrl[1]", 0 ],
			"obj-1::obj-53" : [ "pictctrl[13]", "pictctrl[1]", 0 ],
			"obj-1::obj-54" : [ "pictctrl[18]", "pictctrl[1]", 0 ],
			"obj-1::obj-56::obj-23" : [ "gswitch2[6]", "gswitch2", 0 ],
			"obj-1::obj-62" : [ "pictctrl[14]", "pictctrl[1]", 0 ],
			"obj-1::obj-64" : [ "pictctrl[12]", "pictctrl[1]", 0 ],
			...
			"obj-24::obj-47" : [ "pictctrl[10]", "pictctrl[1]", 0 ],
			"obj-24::obj-51" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-24::obj-53" : [ "pictctrl[11]", "pictctrl[1]", 0 ],
